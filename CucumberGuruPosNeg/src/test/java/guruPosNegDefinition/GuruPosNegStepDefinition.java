...
public class GuruPosNegStepDefinition {
	...
	public void user_should_be_in_the(String string) {
	    ...
	    titleAssert.assertEquals(etitle, atitle);
	...
	public void user_should_be_in(String string) {
	    ...
	    SoftAssert titleAssert2=new SoftAssert();
	    titleAssert2.assertEquals(rtitle, currenttitle);
	    titleAssert2.assertAll();
